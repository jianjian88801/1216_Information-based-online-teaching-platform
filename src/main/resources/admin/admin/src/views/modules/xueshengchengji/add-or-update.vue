<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="科目1成绩" prop="kemu1chengji">
          <el-input v-model="ruleForm.kemu1chengji" 
              placeholder="科目1成绩" clearable  :readonly="ro.kemu1chengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="科目1成绩" prop="kemu1chengji">
              <el-input v-model="ruleForm.kemu1chengji" 
                placeholder="科目1成绩" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="科目2成绩" prop="kemu2chengji">
          <el-input v-model="ruleForm.kemu2chengji" 
              placeholder="科目2成绩" clearable  :readonly="ro.kemu2chengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="科目2成绩" prop="kemu2chengji">
              <el-input v-model="ruleForm.kemu2chengji" 
                placeholder="科目2成绩" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="科目3成绩" prop="kemu3chengji">
          <el-input v-model="ruleForm.kemu3chengji" 
              placeholder="科目3成绩" clearable  :readonly="ro.kemu3chengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="科目3成绩" prop="kemu3chengji">
              <el-input v-model="ruleForm.kemu3chengji" 
                placeholder="科目3成绩" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="科目4成绩" prop="kemu4chengji">
          <el-input v-model="ruleForm.kemu4chengji" 
              placeholder="科目4成绩" clearable  :readonly="ro.kemu4chengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="科目4成绩" prop="kemu4chengji">
              <el-input v-model="ruleForm.kemu4chengji" 
                placeholder="科目4成绩" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
          ...
          if(o=='kemu1chengji'){
            this.ruleForm.kemu1chengji = obj[o];
	    this.ro.kemu1chengji = true;
            continue;
          }
          if(o=='kemu2chengji'){
            this.ruleForm.kemu2chengji = obj[o];
	    this.ro.kemu2chengji = true;
            continue;
          }
          if(o=='kemu3chengji'){
            this.ruleForm.kemu3chengji = obj[o];
	    this.ro.kemu3chengji = true;
            continue;
          }
          if(o=='kemu4chengji'){
            this.ruleForm.kemu4chengji = obj[o];
	    this.ro.kemu4chengji = true;
            continue;
          }
        }
      }
